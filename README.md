...
DELTA["DaIcon"].MouseButton1Click:Connect(function()
    DELTA["22"].Visible = true
    DELTA["85"].Visible = true
    DELTA["DaIcon"].Visible = false
end)
